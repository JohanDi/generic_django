...
INSTALLED_APPS = [
    ...
    'rest_framework',
    'django_filters',
    'sample_project.user_core.apps.UserCoreConfig',
    'sample_project.inventory_app.apps.InventoryAppConfig',
    'src.my_django_generics.apps.MyDjangoGenericsConfig'
]
...
TEMPLATES = [
    {
        ...
        'DIRS': [
            #BASE_DIR / 'templates',
            ROOT_DIR / 'src/my_django_generics/templates',  # Allows to use templates from the root directory
...
REST_FRAMEWORK = {
    ...
    'DEFAULT_PAGINATION_CLASS': 'sample_project.pagination.CustomPageNumberPagination',
    'DEFAULT_METADATA_CLASS': 'sample_project.metadata.CustomMetadata',
...
STATICFILES_DIRS = [
    ...
    ROOT_DIR / "src/my_django_generics/static",  # Allows to use static files from the root directory
]
